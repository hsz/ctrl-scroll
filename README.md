...
![Build](https://github.com/hsz/ctrl-scroll/workflows/Build/badge.svg)
...
- Manually:
  ...
  Download the [latest release](https://github.com/hsz/ctrl-scroll/releases/latest) and install it manually using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>
